...
public class SelectCeilAvgCountFromAnalysisresultTest {
	...
	public static void main(String[] args) throws SQLException, NamingException, IOException {
		...
		Select<NumberDao> select = new SelectCeilAvgCountFromAnalysisresult();
		int number = select.getDbObject().getNumber();
